...
LIST_PRICES: dict[str, tuple[Decimal, Decimal, str]] = {
    ...
    "gpt-5.6-terra": (Decimal("2"), Decimal("12"), "list"),
    "gpt-5.6-luna": (Decimal("0.2"), Decimal("1.2"), "list"),
    "gpt-5.4-nano": (Decimal("0.05"), Decimal("0.4"), "list"),
    "gpt-4.1-mini": (Decimal("0.4"), Decimal("1.6"), "list"),
    "gpt-4.1": (Decimal("2"), Decimal("8"), "list"),
    "claude-fable": (Decimal("10"), Decimal("50"), "list"),
    "claude-sonnet-5": (Decimal("2"), Decimal("10"), "list"),
    "claude-opus-5": (Decimal("5"), Decimal("25"), "list"),
    "gemini-2.5-flash": (Decimal("0.3"), Decimal("2.5"), "list"),
    "gemini-2.5-pro": (Decimal("1.25"), Decimal("10"), "list"),
