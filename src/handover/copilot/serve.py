...
_CATALOG: tuple[tuple[str, str, str, str], ...] = (
    ...
    # --- OpenAI (native key) — ids verified live 2026-09-09
    ("gpt-5.6-terra", "GPT-5.6 Terra", "openai", "flagship · $2/$12"),
    ("gpt-5.6-luna", "GPT-5.6 Luna", "openai", "fast · $0.2/$1.2"),
    ("gpt-5.5", "GPT-5.5", "openai", "strong"),
    ("gpt-5.4-mini", "GPT-5.4 mini", "openai", "cheap"),
    ("gpt-5.4-nano", "GPT-5.4 nano", "openai", "cheapest"),
    ("gpt-5.3-codex", "GPT-5.3 Codex", "openai", "code"),
    ("gpt-4.1", "GPT-4.1", "openai", "long context"),
    ("gpt-4o-mini", "GPT-4o mini", "openai", "legacy · cheap"),
    ("o3", "o3", "openai", "reasoning"),
    # --- Anthropic (native key)
    ("claude-fable-5-1", "Claude Fable 5.1", "anthropic", "frontier · $10/$50"),
    ("claude-opus-5", "Claude Opus 5", "anthropic", "top code · $5/$25"),
    ("claude-sonnet-5", "Claude Sonnet 5", "anthropic", "workhorse · $2/$10"),
    ("claude-haiku-4-5-20251001", "Claude Haiku 4.5", "anthropic", "fast · $1/$5"),
    ...
    # --- DeepSeek / Mistral (native keys)
    ("deepseek-reasoner", "DeepSeek Reasoner", "deepseek", "reasoning · cheap"),
    ("deepseek-chat", "DeepSeek Chat", "deepseek", "cheap"),
    ("mistral-medium-latest", "Mistral Medium 3.5", "mistral", "strong"),
    ("mistral-small-latest", "Mistral Small", "mistral", "free tier · cheap"),
    ("codestral-latest", "Codestral", "mistral", "code"),
    # --- OpenRouter (one key, every lab) — newest first
    ("openai/gpt-6-astra", "GPT-6 Astra", "openrouter", "🆕 frontier · $10/$50"),
    ...
    ("meta/muse-spark-1.3", "Muse Spark 1.3 (Meta)", "openrouter", "🆕 vision · 1M ctx"),
    ("qwen/qwen3.8-max-0902", "Qwen3.8 Max", "openrouter", "strong"),
    ("qwen/qwen3.8-flash", "Qwen3.8 Flash", "openrouter", "cheap"),
    ("moonshotai/kimi-k3", "Kimi K3", "openrouter", "reasoning"),
    ("minimax/minimax-m3", "MiniMax M3", "openrouter", "cheap"),
    ("mistralai/mistral-medium-3-5", "Mistral Medium 3.5", "openrouter", "strong"),
    # --- Groq (free tier key) — measured by the Bourse
    ("openai/gpt-oss-120b", "GPT-OSS 120B", "groq", "free · fast · graded"),
    ("openai/gpt-oss-20b", "GPT-OSS 20B", "groq", "free · fastest · graded"),
    ("qwen/qwen3.8-27b", "Qwen3.8 27B", "groq", "free · graded"),
)
